...
class ChannelRegistry:
    ...
    def is_system_wide(self, channel_id: str) -> bool:
        ...
        return channel_info.scope == ChannelScope.SYSTEM_WIDE if channel_info else False
    ...
    def is_recipient_specific(self, channel_id: str) -> bool:
        ...
        channel_info = self.get(channel_id)
        return (
            channel_info.scope == ChannelScope.RECIPIENT_SPECIFIC
            if channel_info
            else False
        )
    ...
    def filter_by_scope(self, scope: ChannelScope) -> list[ChannelInfo]:
        ...
        ----------
        scope : ChannelScope
            Scope to filter by (SYSTEM_WIDE or RECIPIENT_SPECIFIC).
