...
class ConfigValidator:
    ...
    @staticmethod
    def validate_identity(identity: RecipientData) -> None:
        ...
        if not isinstance(identity.type, RecipientType):
            raise FieldValidationError(
                ID_CONFIG_TYPE_KEY,
    ...
    @staticmethod
    def validate_identity_config(config: RecipientConfig) -> None:
