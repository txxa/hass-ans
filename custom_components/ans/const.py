...
SYS_MIN_RETRY_BASE_DELAY_SECONDS = 10
SYS_MAX_RETRY_BASE_DELAY_SECONDS = 300
SYS_MIN_RETRY_BACKOFF_FACTOR = 1.0
SYS_MAX_RETRY_BACKOFF_FACTOR = 3
...
SYS_STORAGE_NOTIFICATIONS_FILE = "ans.notifications"
SYS_STORAGE_ATTEMPTS_FILE = "ans.delivery_attempts"
SYS_STORAGE_RETRIES_FILE = "ans.retry_queue"
SYS_STORAGE_ACKNOWLEDGEMENTS_FILE = "ans.acknowledgements"
SYS_STORAGE_VOLUME_RESTORATION_FILE = "ans.volume_restoration"
